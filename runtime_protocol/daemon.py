...
class RuntimeDaemon:
    ...
    def __init__(self, root, *, support_root=None, display_name="Workspace", host="127.0.0.1", port=0):
    ...
    def start(self):
        ...
        self.discovery.publish(endpoint=self.endpoint, pid=os.getpid(), instance_id=self.instance_id, realm_id=self.service.realm["id"], protocol_version="core-v1", schema_version=1, coordinator_epoch=self.instance_id, credential_file=str(self.credential_path))
